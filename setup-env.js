...
if (!fs.existsSync(envPath)) {
    ...
    try {
        ...
        console.log('   - Razorpay: Dummy keys (online payment disabled)');
        console.log('');
        console.log('⚠️  For production, please update the Razorpay keys in .env file');
...
console.log('3. Run: cd backend && node seedData.js');
console.log('4. Run: cd backend && npm start');
console.log('');
console.log('💡 If you need online payments, get Razorpay keys from https://dashboard.razorpay.com/');
